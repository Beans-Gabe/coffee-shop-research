...
1. Number of enforced protocols (mask mandates, seating restrictions, contactless payment, temperature checks)
2. Level of enforcement (corporate-mandated vs. discretionary policies)
3. Consistency across locations (chains might have uniform policies, while independents might vary)

### Plan for Data Wrangling
1. Filter for relevant variables
2. Fix inconsistencies: If protocols are recorded differently, make sure they are uniform.
3. Time Period Standardization: If visitations or protocols changed over time, align them to a consistent timeframe
